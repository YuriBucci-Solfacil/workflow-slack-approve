        ...
        try {
            ...
            function getUserIdByEmail(email) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        const response = yield web.users.lookupByEmail({
                            email: email
                        });
            ...
            function getDirectMessageChannel(userID) {
                var _a;
                return __awaiter(this, void 0, void 0, function* () {
                    if (!userID) {
                    ...
                    try {
                        ...
                        const conversationResponse = yield web.conversations.open({
                            users: userID
                        });
                        if (conversationResponse.ok && ((_a = conversationResponse.channel) === null || _a === void 0 ? void 0 : _a.id)) {
            ...
            if (!finalUserId && user_email) {
                ...
                const emailLookupResult = yield getUserIdByEmail(user_email);
